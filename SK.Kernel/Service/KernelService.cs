...
using SK.Kernel.Models.Constants;

#pragma warning disable SKEXP0001, SKEXP0110, SKEXP0050, SKEXP0070 
...
public class KernelService
{
    ...
    public KernelService(IOptions<KernelOptions> options)
    {
        ...
        _kernel = KernelExtensions.GetKernelBuilder(kernelOptions).Build();
