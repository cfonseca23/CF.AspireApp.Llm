...
namespace CF.AspireApp.Llm.Web
{
    public class TextStreamApiClient
    {
        ...
        public async IAsyncEnumerable<string?> GetLinesWithHistoryToolAsync(string userInput, ChatHistory chatHistory, [EnumeratorCancellation] CancellationToken cancellationToken = default)
        {
            if (string.IsNullOrEmpty(userInput))
            {
                throw new ArgumentException("User input is required.", nameof(userInput));
        ...
        #region RAG
        public async IAsyncEnumerable<string?> GetLinesFromArticlesAsync(IList<(string Id, string Text)> articles, string userInput, [EnumeratorCancellation] CancellationToken cancellationToken = default)
        {
            if (string.IsNullOrEmpty(userInput))
            {
                throw new ArgumentException("User input is required.", nameof(userInput));
